            ...
            >
                ...
                >
                    ...
                    <div className={cn("relative z-50", className)}>
                        <div className="transform transition-all duration-300 group-hover:scale-90">{children}</div>
                    </div>
                </div>
            </div>
...
export const PinPerspective = ({ title, href }: { title?: string; href?: string }) => {
    return (
        <motion.div className="pointer-events-none w-96 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500 mb-20">
